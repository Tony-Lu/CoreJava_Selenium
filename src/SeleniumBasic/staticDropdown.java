...
public class staticDropdown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("ctl00_mainContent_rbtnl_Trip_1")).click(); // click Round trip
		driver.findElement(By.id("ctl00_mainContent_view_date1")).click(); // here is for activate this element only
		driver.findElement(By.cssSelector(".ui-datepicker-week-end.ui-datepicker-days-cell-over.ui-datepicker-today")).click(); 
		//how to keep the return date pop-up for the next step?
		Thread.sleep(2000);	
